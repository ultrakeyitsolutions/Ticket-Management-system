...
setTimeout(() => {
    ...
    actionButtons.forEach(function(button, index) {
        ...
        // Only process menu items if menuPanel exists
        if (menuPanel) {
            // Convert menu items
            ...
            menuItems.forEach(item => {
                ...
                if (item.textContent.includes('Reset Password')) {
                    ...
                    // Add reset password click handler only if modal exists
                    if (document.getElementById('setPasswordModal')) {
                        ...
                        console.log('Password reset modal not found, skipping password reset functionality');
                    }
                } else {
        ...
        button.addEventListener('click', function(e) {
            ...
            if (menuPanel) {
                ...
                console.warn('Menu panel not found for button:', button);
            }
        });
    });
