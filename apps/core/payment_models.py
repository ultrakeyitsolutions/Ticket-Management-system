...
This module contains models for payment processing, subscription management,
and billing plans for the ticket system.

Models:
- Plan: Subscription plans with pricing and features
- PlanFeature: Features associated with each plan
